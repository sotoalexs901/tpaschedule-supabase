...
export default function EmployeeDashboardPage() {
  ...
  // 🔔 Cargar anuncios para empleados
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* ✔ Quick Actions – tarjetas futuristas */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        >
          ...
          <div className="text-xl font-semibold mt-1 text-white">Weekly Hours</div>
          <p className="text-xs text-slate-300 mt-2 leading-relaxed">
            View your approved schedules and weekly assignments.
          </p>
        </div>

        {/* Card 2 – PTO / Day Off (INTERNA) */}
        <div
        ...
        >
          ...
          <div className="text-xl font-semibold mt-1 text-white">Send Request</div>
          <p className="text-xs text-slate-300 mt-2 leading-relaxed">
            Submit time-off requests directly to HR/Management from your profile.
          </p>
        </div>

        {/* Card 3 – PTO Status (INTERNO) */}
        <div
        ...
        >
          ...
          <div className="text-xl font-semibold mt-1 text-white">Track Status</div>
          <p className="text-xs text-slate-300 mt-2 leading-relaxed">

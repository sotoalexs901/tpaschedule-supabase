    ...
    const html = `
      ...
      <html>
        ...
        <body>
          ...
          <div class="subtitle">
            ${selectedReport.date || "—"} · ${selectedReport.submittedBy || selectedReport.employeeName || "—"}
          </div>
        ...
        >
          ...
          <div>
            ...
            <TextInput
              ...
              placeholder="Airline, employee, date, flight..."
            />
          </div>
        </div>
      </PageCard>
            ...
            <div style={{ display: "grid", gap: 10 }}>
              {visibleReports.map((item) => (
                ...
                >
                  ...
                  >
                    {item.submittedBy || item.employeeName || "—"}
                  </div>
                </div>
              ))}
            </div>
